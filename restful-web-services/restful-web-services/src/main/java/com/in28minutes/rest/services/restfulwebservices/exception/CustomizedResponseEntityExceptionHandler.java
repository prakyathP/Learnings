...
@ControllerAdvice//Making this applicable to all the controllers and test controllers defined in this package
public class CustomizedResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @Override //overriding the method defined in ResponseEntityExceptionHandler
